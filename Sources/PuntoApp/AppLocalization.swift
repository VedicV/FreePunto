...
enum AppText {
    ...
    private static let russian: [Key: String] = [
        ...
        .globalHotkeysUnavailableDetail: "Разрешите Accessibility и Input Monitoring для FreePunto, затем перезапустите приложение.",
    ...
    private static let ukrainian: [Key: String] = [
        ...
        .globalHotkeysUnavailableDetail: "Дозвольте Accessibility та Input Monitoring для FreePunto, потім перезапустіть застосунок.",
    ...
    private static let english: [Key: String] = [
        ...
        .globalHotkeysUnavailableDetail: "Enable Accessibility and Input Monitoring for FreePunto, then restart the app.",
