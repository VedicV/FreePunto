...
Це посилання веде на файл DMG у GitHub Releases. Воно почне працювати після публікації релізу `v0.1.4` і завантаження asset-файлу `FreePunto-0.1.4.dmg`.

## Встановлення

1. Завантажте DMG.
2. Відкрийте `FreePunto-0.1.4.dmg`.
